    ...
    try {
      ...
      if (context.shipping_receiver) {
        salesOrder.setValue({
          ...
          value: "A/C: " + context.shipping_receiver,
        });
      }

      salesOrder.setValue({
        fieldId: "custbody_udf_portal_order_id",
      ...
      if (context.shipping_option.delivery_method_name === "Correios PAC") {
        ...
        context.shipping_option.delivery_method_name ===
        "Correios Registro Módico"
      ) {
        salesOrder.setValue({
          fieldId: "shipmethod",
          value: 3750,
        ...
        salesOrder.setValue({
          fieldId: "custbody_enl_freighttype",
          value: "10",
        });
      ...
      products.forEach(function (product) {
        ...
        if (
          ...
          if (context.inscription_type === "single") {
            salesOrder.setCurrentSublistValue({
              sublistId: "item",
              fieldId: "price",
              value: 6,
            });
          } else if (context.inscription_type === "couple") {
            salesOrder.setCurrentSublistValue({
              sublistId: "item",
              fieldId: "price",
              value: 10,
