...
// CRUD default event schedules
Route.resource(
  'default_event_schedules',
  'DefaultEventSchedulesController'
).except(['edit', 'create', 'show'])

Route.get(
  'default_event_schedules/:default_event_id',
  'DefaultEventScheduleController.show'
)
...
Route.put(
  ...
  'OrganizationController.update_netsuite'
)
...
Route.put(
  'organizator_print_date',
  'EventOrganizatorController.updatePrintDate'
)
...
Route.get('searchParticipant/:cpf_email/:default_event_id/:event_id', 'EventParticipantController.searchParticipant')
Route.delete(
...
Route.resource('bank_account', 'BankAccountController').except([
  'edit',
  'create'
])
...
Route.get(
  ...
  'RelationshipController.indexEntity'
)
