...
class Entity extends Model {
  ...
  relationships() {
    return this.hasMany("App/Models/Relationship").orderBy("id");
  }
  ...
  static updateHierarchy(ids, hierarchyName, hierarchyWillBecome) {
    const entities = this.query()
      .whereIn("id", ids)
      .andWhere(hierarchyName, "<", hierarchyWillBecome)
  ...
  static updateLeaderTrainingHierarchy(
    entityId,
    hierarchyName,
    assistantHierarchyId,
    type
  ) {
    if (type === "delete") {
